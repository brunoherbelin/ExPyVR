...
class ModuleMain(DrawableHUDModule):
    ...
    def __init__(self, controller, initConfig=None, runConfigs=None):
        ...
        line = ['routine', 'exp_time', 'display_time', 'alpha']
    ...
    def draw(self, window_width, window_height):
        ...
        line = [name, str(self.controller.gTimeManager.experimentTime()), str(self.controller.gTimeManager.displayTime()), str(self.alpha)]
        self.csvLogger.writerow(line)
